...
Или можно сформировать sql файл и применить его отдельно с прогрессбаром. Важно, что формирование sql файла из бинарных логов не требует много времени, в отличие от его проигрывания в mysql.
